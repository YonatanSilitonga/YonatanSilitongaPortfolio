  ...
  projects: [
    {
      ...
      github: [
        { label: 'Web', url: 'https://github.com/YonatanSilitonga/admin_panel' },
        { label: 'Mobile', url: 'https://github.com/YonatanSilitonga/flutter_project' },
      ],
      demo: 'Coming Soon',
    ...
    },
    {
      ...
      github: [
        { label: 'Web', url: 'https://github.com/YonatanSilitonga/AdminPanel' },
        { label: 'Mobile', url: 'https://github.com/dedensinurat/smarttourismflutter' },
      ],
      demo: 'Belum tersedia',
    ...
    },
    {
      ...
      github: [{ label: 'GitHub', url: 'https://github.com/YonatanSilitonga/SMPN3_Laguboti' }],
      demo: 'Belum tersedia',
    ...
    },
    {
      ...
      github: [{ label: 'GitHub', url: 'https://github.com/YonatanSilitonga/Data-Sains-Data-Analisis-Kelompok-3' }],
      demo: 'Belum tersedia',
    ...
    },
    {
      ...
      github: [{ label: 'GitHub', url: 'https://github.com/YonatanSilitonga/ProjekTokoMaterialCVFeliks' }],
      demo: 'Belum tersedia',
    ...
    },
    {
      ...
      github: [{ label: 'GitHub', url: 'https://github.com/Hyzity/Object-Detection-with-multi-label-classification' }],
      demo: 'Belum tersedia',
